...
# y, sr = librosa.load("voice_data/test_유인나1.wav")
y, sr = librosa.load("voice_data/test_문재인대통령.wav")
...
# print("y_test_estimated = " + str(y_test_estimated))
